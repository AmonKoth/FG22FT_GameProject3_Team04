...
void UTankComponent::UpgradeALevel(int TypeContainer, EAbilityLevel& TypeLevel)
{
	...
	if (TypeContainer >= (MaxCapacity/3) && TypeLevel == EAbilityLevel::EAL_Level0)
	{
		TypeLevel = EAbilityLevel::EAL_Level1;
	}
	else if (TypeContainer >= (MaxCapacity/3*2) && TypeLevel == EAbilityLevel::EAL_Level1)
	{
		TypeLevel = EAbilityLevel::EAL_Level2;
	}
	else if (TypeContainer >= MaxCapacity && TypeLevel == EAbilityLevel::EAL_Level2)
	{
...
{
	if (TypeContainer <= (MaxCapacity / 3 * 2) && TypeLevel == EAbilityLevel::EAL_Level3)
	{
		TypeLevel = EAbilityLevel::EAL_Level2;
	}
	else if (TypeContainer <= (MaxCapacity / 3) && TypeLevel == EAbilityLevel::EAL_Level2)
	{
		TypeLevel = EAbilityLevel::EAL_Level1;
	}
